...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (userData.role !== 'admin') {
      router.push('/references/categories'); // Redirect non-admins to a safe page
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex relative">
      ...
      <div className="flex-1 flex flex-col">
        {/* Header */}
        <TopBar title="Tableau de Bord" isSidebarOpen={isSidebarOpen} onToggleSidebar={toggleSidebar} />
