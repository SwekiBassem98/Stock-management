      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="rounded-xl border border-indigo-100 bg-indigo-50 p-4">
          ...
          <p className="mt-1 text-sm text-indigo-800">
            Importez uniquement un fichier CSV avec une ligne d&apos;en-tête.
          </p>
        ...
        <div>
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-900">
              {file ? file.name : 'Déposez votre fichier CSV ici ou cliquez pour le sélectionner'}
            </span>
            <span className="mt-1 text-xs text-gray-500">Formats acceptés: .csv, text/csv</span>
            <input
              id="csv-file"
              name="csv"
              type="file"
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-1 text-sm text-rose-900">
                      Les lignes suivantes n&apos;ont pas été importées. Corrigez-les dans votre CSV puis relancez l&apos;import.
                    </p>
        ...
        <div className="flex gap-3 pt-2">
          ...
          >
            {isLoading ? 'Import en cours...' : 'Importer le CSV'}
          </button>
        </div>
      </form>
    </Modal>
